...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        render_voxels(voxels_src, save_dir='results/q1.1', save_name='q1.1_gt.gif')
        render_voxels(voxels_tgt, save_dir='results/q1.1', save_name='q1.1_target.gif')

        # fitting
        fit_voxel(voxels_src, voxels_tgt, args)

        # optimized voxel visulization
        render_voxels(voxels_src, save_dir='results/q1.1', save_name='q1.1_optimized.gif')
        ...
        # visualization & saving
        render_ptcloud(pointclouds_src, save_dir='results/q1.2', save_name='q1.2_gt.gif')
        render_ptcloud(pointclouds_tgt, save_dir='results/q1.2', save_name='q1.2_target.gif')

        # fitting
        fit_pointcloud(pointclouds_src, pointclouds_tgt, args)      

        # optimized pt cloud visulization
        render_ptcloud(pointclouds_src, save_dir='results/q1.2', save_name='q1.2_optimized.gif')  
        ...
        render_mesh(mesh_src, save_dir='results/q1.3', dist=2, save_name='q1.3_gt.gif')
        render_mesh(mesh_tgt, save_dir='results/q1.3', dist=1.5, save_name='q1.3_target.gif')
        
        # fitting
        fit_mesh(mesh_src, mesh_tgt, args)        

        render_mesh(mesh_src, save_dir='results/q1.3', dist=1.5, save_name='q1.3_optimized.gif')
